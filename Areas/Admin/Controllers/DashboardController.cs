...
namespace Web_dienmay.Areas.Admin.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.LastMonthRevenue = await _context.Orders
            ...
            {
                ViewBag.RevenueGrowth = Math.Round(((double)ViewBag.MonthlyRevenue - ViewBag.LastMonthRevenue) / ViewBag.LastMonthRevenue * 100, 1);
            }
            else
            {
            ...
            if (dayOfMonth > 0)
            {
                var dailyAverage = (decimal)ViewBag.MonthlyRevenue / dayOfMonth;
            ...
            foreach (var month in last6Months)
            {
                ...
                revenueChartData.Add(monthlyRevenue);
            }
